...
namespace osc {
    ...
    public:
		...
		const int get_max_queue() { return _max_queue; }

        void set_avoid_duplicate( bool enabled );
		const bool get_avoid_duplicate() { return _avoid_duplicate; }

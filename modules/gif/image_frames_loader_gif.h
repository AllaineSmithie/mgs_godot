...
public:
	virtual Error load_image_frames(Ref<ImageFrames> &r_image_frames, const Ref<FileAccess>& f, int max_frames = 0) const;
...
public:
	Error load_from_file_access(Ref<ImageFrames> &r_image_frames, const Ref<FileAccess>& f, int max_frames = 0);

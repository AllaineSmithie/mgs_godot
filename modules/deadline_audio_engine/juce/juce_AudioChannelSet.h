/*
  ...
  ==============================================================================
*/
#ifndef JUCE_AUDIO_CHANNEL_SET_H
#define JUCE_AUDIO_CHANNEL_SET_H
	...
	*/
	...
	public:
		...
		*/
		...
		static Vector<AudioChannelSet> JUCE_CALLTYPE channelSetsWithNumberOfChannels(int numChannels);
		...
		Vector<ChannelType> getChannelTypes() const;
		...
		*/
		static AudioChannelSet JUCE_CALLTYPE channelSetWithChannels(const Vector<ChannelType>&);
		...
		/** Create an AudioChannelSet from a WAVEFORMATEXTENSIBLE channelMask (typically used
			in .wav files). */
		static AudioChannelSet JUCE_CALLTYPE fromWaveChannelMask(int32_t dwChannelMask);
		...
		/** Returns a WAVEFORMATEXTENSIBLE channelMask representation (typically used in .wav
			...
			representation.
		*/
		int32_t getWaveChannelMask() const noexcept;
	...
	private:
		...
		//==============================================================================
		explicit AudioChannelSet(uint32_t);
...
#endif // JUCE_AUDIO_CHANNEL_SET_H

...
protected:
	static void _bind_methods()
	{
		ClassDB::bind_method(D_METHOD("set_sound_file", "sound_file"), &SFZRegion::set_sound_file);
		ClassDB::bind_method(D_METHOD("get_sound_file"), &SFZRegion::get_sound_file);

		ADD_PROPERTY(PropertyInfo(Variant::NODE_PATH, "sound_file", PROPERTY_HINT_NODE_PATH_VALID_TYPES, "AudioStreamPRO"), "set_sound_file", "get_sound_file");
	}
public:
	void set_sound_file(const NodePath &p_sound_file) { sound_file = p_sound_file; }
	NodePath get_sound_file() const { return sound_file; }
};
...
protected:
	static void _bind_methods()
	{
		...
		ClassDB::bind_method(D_METHOD("set_mic_channels", "mic_channels"), &Instrument::set_mic_channels);
		ClassDB::bind_method(D_METHOD("get_mic_channels"), &Instrument::get_mic_channels);

		ClassDB::bind_method(D_METHOD("set_master_opcodes", "master_opcodes"), &Instrument::set_master_opcodes);
		ClassDB::bind_method(D_METHOD("get_master_opcodes"), &Instrument::get_master_opcodes);
		ClassDB::bind_method(D_METHOD("set_global_opcodes", "global_opcodes"), &Instrument::set_global_opcodes);
		ClassDB::bind_method(D_METHOD("get_global_opcodes"), &Instrument::get_global_opcodes);
		ClassDB::bind_method(D_METHOD("set_control_opcodes", "control_opcodes"), &Instrument::set_control_opcodes);
		ClassDB::bind_method(D_METHOD("get_control_opcodes"), &Instrument::get_control_opcodes);
		ClassDB::bind_method(D_METHOD("set_definitions", "definitions"), &Instrument::set_definitions);
		ClassDB::bind_method(D_METHOD("get_definitions"), &Instrument::get_definitions);
...
public:
	...
	void set_master_opcodes(const Dictionary &p_master_opcodes) { master_opcodes = p_master_opcodes; }
	Dictionary get_master_opcodes() { return master_opcodes; }
	void set_global_opcodes(const Dictionary &p_global_opcodes) { global_opcodes = p_global_opcodes; }
	Dictionary get_global_opcodes() { return global_opcodes; }
	void set_control_opcodes(const Dictionary &p_control_opcodes) { control_opcodes = p_control_opcodes; }
	Dictionary get_control_opcodes() { return control_opcodes; }
	void set_definitions(const Dictionary &p_definitions) { definitions = p_definitions; }
